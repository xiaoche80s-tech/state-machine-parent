...
public final class MachineDefinitionDTO {
    ...
    @JsonProperty public String version() { return version; }
    @JsonProperty public List<Map<String, Object>> states() { return states; }
    @JsonProperty public List<Map<String, Object>> transitions() { return transitions; }
    @JsonProperty public Map<String, Object> retryPolicy() { return retryPolicy; }
    @JsonProperty public Instant registeredAt() { return registeredAt; }
